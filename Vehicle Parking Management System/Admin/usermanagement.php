                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="" placeholder="-          First Name           -        Middle Name          -       Last Name         -">
                                </div>
                              </div>
                              ...
                              <div class="col-6">
                                <div class="form-group">
                                  ...
                                  <input type="password" class="form-control" id="" placeholder="Enter User Category ..">
                                </div>
                              </div>
                              <div class="col-6">
                                <div class="form-group">
