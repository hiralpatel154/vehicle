          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Booking Data table</h3> 
                            ...
                            <div class="card card-primary">
                              ...
                              <div class="col-3">
                                <div class="form-group">
                                  ...
                                  <input type="time" class="form-control" id="" placeholder="0:00">
                                </div>
                              </div>
                              <div class="col-9">
                                <div class="form-group">
                            ...
                            <div class="card card-primary">
                              ...
                              <div class="col-9">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="" placeholder="Enter Booking Status ..">
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">
