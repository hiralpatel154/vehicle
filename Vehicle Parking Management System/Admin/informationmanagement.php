        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item menu-open">
                <a href="informationmanagement.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Information Management</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Vehicle Information Data table</h3> 
              <button class="btn btn-success btn-xs" style="margin-left: 72%" data-toggle="modal" data-target="#add"><i class="fa fa-plus"></i> Add</button>
                            ...
                            <div class="card card-primary">
                              ...
                              <div class="col-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="" placeholder="Enter Plate Number ..">
                                </div>
                              </div>
                               <div class="col-6">
                                <div class="form-group">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <tr>
                    <td><img src="../dist/img/bg.jpg" class="img-square elevation-3" style="width:50px;  border-radius:10%;" alt="User Image">   </td>
